...
import { customerApi, dispatchRegionApi, type Customer, type CreateCustomerRequest, type CustomerType, type UpdateCustomerRequest } from '../api/setup';
...
export default function CustomerFormDialog({ isOpen, onClose, customer }: CustomerFormDialogProps) {
  ...
  const handleCreateSubmit = (e: React.FormEvent) => {
    ...
    const request: CreateCustomerRequest = isBillingOnly
      ? {
          ...
          accountManagerUserId: createFormData.accountManager?.id ?? null,
  ...
  const handleEditSubmit = (e: React.FormEvent) => {
    ...
    const customerRequest: UpdateCustomerRequest = {
      ...
      accountManagerUserId: editFormData.accountManager?.id ?? null,
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <Field>
                        ...
                        <AccountManagerPicker
                          value={createFormData.accountManager}
                          onChange={(u) => setCreateFormData((prev) => ({ ...prev, accountManager: u }))}
                        />
                      </Field>
                      <Field>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <Field>
                        ...
                        <AccountManagerPicker
                          ...
                          onChange={(u) => setEditFormData((prev) => ({ ...prev, accountManager: u }))}
                        />
                      </Field>
                      <Field>
                        <Label className="text-xs">{t('customers.detail.industry')}</Label>
