...
// them through the '@dispatch/api' barrel) so we can assert the entity-specific call
...
vi.mock('@dispatch/api/src/noteApi', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../api/setup')>();
  return {
    ...actual,
    noteApi: {
...
vi.mock('@dispatch/api/src/notesApi', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../api/setup')>();
  return {
    ...actual,
    notesApi: {
