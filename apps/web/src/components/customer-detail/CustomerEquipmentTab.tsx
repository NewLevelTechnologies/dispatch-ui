...
import { equipmentApi, EquipmentStatus, type EquipmentSummary, type ListEquipmentParams } from '../../api/setup';
                  ...
                  {rows.map((item) => (
                    <DenseRow key={item.id}>
                      <td>
                        ...
                        >
                          <EquipmentThumbnail url={item.profileImageUrl} name={item.name} category={item.equipmentCategoryName} type={item.equipmentTypeName} monogram sizeClass="size-9" fit="contain" />
