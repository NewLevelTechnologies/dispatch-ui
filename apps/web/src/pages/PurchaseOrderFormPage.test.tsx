...
import type { PurchaseOrderResponse } from '../api/setup';
...
vi.mock('@dispatch/api/src/purchaseOrderApi', async () => {
  const actual = await vi.importActual<typeof import('../api/setup')>('@dispatch/api/src/purchaseOrderApi');
  return {
    ...actual,
    purchaseOrderApi: {
      list: vi.fn(),
...
vi.mock('@dispatch/api/src/workOrderApi', async () => {
  const actual = await vi.importActual<typeof import('../api/setup')>('@dispatch/api/src/workOrderApi');
  return {
    ...actual,
