...
vi.mock('react-i18next', () => {
  const translations = {
    ...
    'serviceLocations.activity.audit.changedFields': 'Changed {{count}} fields',
    ...
    'serviceLocations.activity.filter.payments': 'Payments',
    'serviceLocations.activity.filter.visits': 'Visits',
