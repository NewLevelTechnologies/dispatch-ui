...
vi.mock('react-i18next', () => {
  const translations = {
    ...
    'roles.actions.deleteWarning': 'This action cannot be undone. Users currently assigned to this role will lose these permissions.',
    'roles.description': 'Define roles with specific permissions and capabilities',
