...
vi.mock('react-i18next', () => {
  const translations = {
    ...
    'equipment.components.addComponent': 'Add Component',
    'equipment.components.addFirstComponent': 'Add the first component',
    'equipment.components.empty': 'No components linked to this equipment yet.',
    'equipment.components.errorLoading': 'Failed to load components',
    'equipment.components.loading': 'Loading components…',
    'equipment.components.titleAdd': 'Add Component to {{parent}}',
    ...
    'equipment.images.limitReached': 'This piece of equipment already has the maximum {{max}} photos.',
    ...
    'equipment.picker.createNew': '+ Create new equipment "{{name}}"',
    'equipment.picker.noResults': 'No equipment found at this location.',
    'equipment.picker.placeholder': 'Search by name, serial, model…',
    'equipment.picker.quickCreateHint': 'Other details can be filled in later.',
    ...
    'equipment.tabs.components': 'Components',
    ...
    'workOrders.workItems.empty': 'No work items on this work order yet.',
    ...
    'workOrders.workItems.title': 'Work Items',
