...
// Covers the legacy category-driven rendering, which still serves SINGLE +
// BILLING_ONLY shapes. Local binding stays `CustomerDetailPage` so the existing
// cases render unchanged; only the module path moved.
import CustomerDetailPage from './CustomerDetailLegacy';
