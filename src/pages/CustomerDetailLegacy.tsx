...
// Legacy category-driven rendering — RESIDENTIAL / COMMERCIAL / BILLING_ONLY.
// Still the live page for SINGLE + BILLING_ONLY shapes; the MULTI shape now
// routes to MultiCustomerDetail (see CustomerDetailPage). Retired branch-by-
// branch as each shape's redesign lands.
export default function CustomerDetailLegacy() {
